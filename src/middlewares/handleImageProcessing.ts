...
import {
    findFullImage, imagePath, getProcessedImageName,
    findProcessedImage, createProcessedImage, processedImagePath
} from '../helpers/imageHelpers';
const path = require('path');


const handleImageProcessing = async(req: Request, res: Response, next: Function) => {
